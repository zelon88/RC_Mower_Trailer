...
// AUTHOR:  Justin Grimes (@zelon88)
// DESCRIPTION:
//    A bracket that joins both Body Halves to the Center Bracket and provides the mounting
//    surface for the Hopper. Two pieces are required per assembly, mirrored front and rear.
// FILE NAME: Hopper_Bracket.scad
// ----------------------------------------------------------------------------------------------------
...
// A module for calling in the Center Bracket for crafting mating surfaces.
