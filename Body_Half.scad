...
module Body_Half_Dirty() {
  ...
  difference() {
    ...
    translate([-32, 40, 16]) cylinder(r1=14, r2=13, h=4, $fn=96, center=false);
    translate([-32, 40, 16]) cylinder(r1=18, r2=13.75, h=2.5, $fn=96, center=false);
    translate([-32, 40, 12]) cylinder(r1=20, r2=18, h=4, $fn=96, center=false);
    // Cut the landing pad for the clippings flange.
    translate([-32, 40, 19.9]) cylinder(r1=19, r2=15.25, h=0.33, $fn=96, center=false);
    ...
    translate([20, 14, 13]) cylinder($fn=64, r=1.22, h=15);
    translate([8.75, 14, 13]) cylinder($fn=64, r=1.22, h=15);
    translate([0, 14, 13]) cylinder($fn=64, r=1.22, h=15);
    translate([-8.75, 14, 13]) cylinder($fn=64, r=1.22, h=15);
    translate([-20, 14, 13]) cylinder($fn=64, r=1.22, h=15);
    // Through hole for planetary shaft.
    translate([0, 0, 0]) rotate([0, 0, 0]) cylinder($fn=64, r=3.03, h=100, center=true);
    // Torus screw holes.
    translate([13.25, 0, 4]) rotate([90, 0, 0]) cylinder($fn=64, r=1.22, h=40, center=true);
    translate([23.25, 0, 7]) rotate([90, 0, 0]) cylinder($fn=64, r=1.22, h=40, center=true);
    translate([33.25, 0, 8]) rotate([90, 0, 0]) cylinder($fn=64, r=1.22, h=40, center=true);
    translate([-13.25, 0, 4]) rotate([90, 0, 0]) cylinder($fn=64, r=1.22, h=40, center=true);
    translate([-23.25, 0, 7]) rotate([90, 0, 0]) cylinder($fn=64, r=1.22, h=40, center=true);
    translate([-33.25, 0, 8]) rotate([90, 0, 0]) cylinder($fn=64, r=1.22, h=40, center=true);
    // Torus screw hole recesses.
    translate([13.25, 10, 4]) rotate([90, 0, 0]) cylinder($fn=64, r=2.15, h=10, center=true);
    translate([23.25, 13, 7]) rotate([90, 0, 0]) cylinder($fn=64, r=2.15, h=10, center=true);
    translate([33.25, 18, 8]) rotate([90, 0, 0]) cylinder($fn=64, r=2.15, h=10, center=true);
    translate([-13.25, 10, 4]) rotate([90, 0, 0]) cylinder($fn=64, r=2.15, h=10, center=true);
    translate([-23.25, 13, 7]) rotate([90, 0, 0]) cylinder($fn=64, r=2.15, h=10, center=true);
    translate([-33.25, 18, 8]) rotate([90, 0, 0]) cylinder($fn=64, r=2.15, h=10, center=true);
  ...
  difference() {
    union() {
      ...
      translate([0, 75, 16]) cylinder(r1=62, r2=57, h=4, $fn=256);
    ...
    translate([0, 0, 0]) Center_Bracket();
    // Mounting holes for the center bracket.
    translate([20, 14, 14]) cylinder($fn=64, r=1.22, h=9.2);
    translate([8.75, 14, 14]) cylinder($fn=64, r=1.22, h=9.2);
    translate([0, 14, 14]) cylinder($fn=64, r=1.22, h=9.2);
    translate([-8.75, 14, 14]) cylinder($fn=64, r=1.22, h=9.2);
    translate([-20, 14, 14]) cylinder($fn=64, r=1.22, h=9.2);
    // Front Attachment Boss screw holes.
    Attachment_Boss_Screw_Holes(52, 1, 75, 10);
    ...
    translate([0, 50, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([0, 40, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([0, 30, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    // Inner Upper Body Stiffener screw holes.
    translate([8, 50, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([8, 40, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([8, 30, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-8, 50, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-8, 40, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-8, 30, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    // Inner Lower Body Stiffener screw holes.
    translate([ 16, 30, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 16, 40, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 16, 50, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 24, 30, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 24, 40, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 24, 50, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 32, 40, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 32, 50, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    translate([ 40, 50, 10]) cylinder($fn=64, r=1.22, h=25, center=true);
    // Outer Body Stiffener screw holes.
    translate([40, 100, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([32, 100, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([32, 110, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([24, 100, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([24, 110, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([24, 120, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([16, 100, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([16, 110, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([16, 120, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([8, 120, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([8, 135, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([0, 135, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-40, 100, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-32, 100, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-32, 110, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-24, 100, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    ...
    translate([46.5, 85, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([46.5, 65, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([8, 88.75, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([8, 62.75, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([16, 75, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([16, 85, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([16, 65, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-16, 75, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-16, 85, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-16, 65, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    translate([-8, 88.75, 10]) cylinder($fn=64, r=1.22, h=15, center=false);
    ...
    translate([32.5, 75, 20.4]) cylinder($fn=64, r1=12.75, r2=12.85, h=1, center=true);
    translate([0, 75, 20.4]) cylinder($fn=64, r1=12.75, r2=12.85, h=1, center=true);
    translate([-32.5, 75, 20.4]) cylinder($fn=64, r1=12.75, r2=12.85, h=1, center=true);
    translate([0, 107.5, 20.4]) cylinder($fn=64, r1=12.75, r2=12.85, h=1, center=true);
    // Body Stiffener landing pads.
    translate([0, 40, 22.25]) rotate([0, 0, 180]) Body_Stiffener_Inner();
    translate([0, 110, 22.25]) Body_Stiffener_Outer(); }
  ...
  difference() {
    ...
    translate([-32, 40, 15]) cylinder(r1=20.75, r2=17.25, h=5, $fn=96, center=false);
    // Cut out the inside of the torus.
    translate([0, 75, 0]) Torus(40, 150);
    translate([0, 75, 0]) cylinder(r=50, h=38, $fn=64, center=false);
    // Cut out the hole for clippings.
    translate([-32, 40, 16]) cylinder(r1=14, r2=13, h=4, $fn=96, center=false);
    translate([-32, 40, 16]) cylinder(r1=18, r2=13.75, h=2.5, $fn=96, center=false);
    translate([-32, 40, 12]) cylinder(r1=20, r2=18, h=4, $fn=96, center=false);
  ...
  difference() {
    ...
    translate([0, 0, 0]) Center_Bracket();
    // Mounting holes for the center bracket.
    translate([20, 14, 10]) cylinder($fn=64, r=1.22, h=15);
    translate([8.75, 14, 10]) cylinder($fn=64, r=1.22, h=15);
    translate([0, 14, 10]) cylinder($fn=64, r=1.22, h=15);
    translate([-8.75, 14, 10]) cylinder($fn=64, r=1.22, h=15);
    translate([-20, 14, 10]) cylinder($fn=64, r=1.22, h=15);
    // Through hole for planetary shaft.
    translate([0, 0, 0]) rotate([0, 0, 0]) cylinder($fn=64, r=3.03, h=100, center=true);
  ...
  difference() {
    union() {
      ...
      translate([71.25, 86.25, 10]) cylinder(r=3, h=10, $fn=64, center=false);
      translate([71.25, 63.75, 10]) cylinder(r=3, h=10, $fn=64, center=false); }
    // Cut out the torus.
    translate([0, 75, 0]) Torus(40, 140);
    // Cut out for the reinforcement slot.
  ...
  difference() {
    union() {
      ...
      // Create the screw hole bosses at the corners.
      translate([11.25, 146.25, 10]) cylinder(r=3, h=10, $fn=64, center=false);
      translate([-11.25, 146.25, 10]) cylinder(r=3, h=10, $fn=64, center=false); }
    // Cut out the torus.
    translate([0, 75, 0]) Torus(40, 140);
    // Cut out for the reinforcement slot.
...
module Body_Half() {
  difference() {
    ...
    translate([0, 45, 10.99995]) cylinder(r=20, h=10, $fn=64, center=true);
    translate([0, 75, 10]) cylinder(r=50, h=10, $fn=64, center=true); } }
