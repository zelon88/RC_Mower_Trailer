...
module Attachment_Adjustment_Arm() {
  difference() {
    ...
    translate([2.55, 0, 11.05]) rotate([0, 35, 0]) cube([10, 25, 10], center=true);
    translate([2.4, 0, 10.5]) rotate([0, 66, 0]) cube([10, 25, 8], center=true);
    // Cut the slot in the paddle for the Attachment Adjustment Arm Insert body.
    translate([26.25, 0, 5]) cube([22, 7, 5], center=true);
    // Cut the boss slots either side of the body slot for the insert side bosses.
    translate([26.25,  5, 7.99]) cube([22, 3.02, 7], center=true);
    translate([26.25, -5, 7.99]) cube([22, 3.02, 7], center=true); 
   // Cut the cover holes.
